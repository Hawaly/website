...
// Interface VideoTaskDetails
export interface VideoTaskDetails {
  id: number;
  task_id: number;
  script: string | null;
...
// Type pour créer des détails de tâche vidéo
export type VideoTaskDetailsInsert = Omit<VideoTaskDetails, 'id' | 'created_at' | 'updated_at'>;

// Type pour mettre à jour des détails de tâche vidéo
export type VideoTaskDetailsUpdate = Partial<Omit<VideoTaskDetails, 'id' | 'task_id' | 'created_at' | 'updated_at'>>;

// Interface VideoFigurant
export interface VideoFigurant {
  id: number;
...
// Type pour créer un figurant
export type VideoFigurantInsert = Omit<VideoFigurant, 'id' | 'created_at' | 'updated_at'>;

// Type pour mettre à jour un figurant
export type VideoFigurantUpdate = Partial<Omit<VideoFigurant, 'id' | 'video_task_id' | 'created_at' | 'updated_at'>>;
